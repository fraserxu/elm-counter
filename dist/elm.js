...
var _user$project$Main$LoadFail = function (a) {
	return {ctor: 'LoadFail', _0: a};
};
var _user$project$Main$LoadSucceed = function (a) {
...
var _user$project$Main$getCount = function () {
	...
	return A3(
		...
		_user$project$Main$LoadSucceed,
		A2(_evancz$elm_http$Http$get, _user$project$Main$decodeCount, url));
}();
...
var _user$project$Main$LoadCount = {ctor: 'LoadCount'};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(model.count)
					])),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$LoadCount)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Load Count')
					]))
			]));
};
